...
//Vincent Do
public class CloudMarioCrouchState : IPlayerState
{
    ...
    public CloudMarioCrouchState(Player Mario)
    {
        this.Mario = Mario;
        ...
        Sprites = [
            texture.NewSprite(136, 374, 16, 32),
            texture.NewAnimatedSprite(136, 374, 16, 32, 4, timeFrame/4)
        ];
