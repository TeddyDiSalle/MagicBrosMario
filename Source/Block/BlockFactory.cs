...
public static class BlockFactory {
    ...
    public static QuestionMarkBlock QuestionMarkBlock() {
        var fullSprite = BLOCK_SHARED_TEXTURE.NewAnimatedSprite(16, 48, 16, 16, 3, 0.2f);
        var emptySprite = BLOCK_SHARED_TEXTURE.NewSprite(64, 48, 16, 16);
        var block = new QuestionMarkBlock(fullSprite, emptySprite);
        return block;
    }
}