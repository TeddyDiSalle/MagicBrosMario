...
public class MagicBrosMario : Game
{
    ...
    private void LoadBlocks()
    {
        ...
        blocks =
        [
            BlockFactory.VoidBlock().WithPosition(100, 100),
            BlockFactory.SkyBlock().WithPosition(100, 100),
            BlockFactory.GroundBlock().WithPosition(100, 100),
            BlockFactory.BlueGroundBlock().WithPosition(100, 100),
            BlockFactory.Bricks().WithPosition(100, 100),
            BlockFactory.BlueBricks().WithPosition(100, 100),
            BlockFactory.BaseBlock().WithPosition(100, 100),
            BlockFactory.QuestionMarkBlock().WithPosition(100, 100),
            BlockFactory.EmptyQuestionMarkBlock().WithPosition(100, 100),
        ];
    }
