...
{
	internal class PoisonMushroom : IItems, ICollidable
	{
		...
		public PoisonMushroom(SharedTexture texture, int positionX, int positionY)
		{
			sprite = texture.NewSprite(237, 34, 16, 16);
			sprite.Scale = 2f;
